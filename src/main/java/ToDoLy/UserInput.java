...
public class UserInput<streamManager> implements Serializable {
    ...
    public void displayMenu() throws ParseException, IOException {
        ...
        while (!setQuit) {
            ...
            System.out.println("1) Add a ToDoLy.Task");
            System.out.println("2) Edit a ToDoLy.Task");
            System.out.println("3) Show ToDoLy.Task List");
            System.out.println("4) Remove a ToDoLy.Task");
    ...
    public void editTask() throws ParseException {
        ...
        simpleTodoList.displayToDoList();
        Scanner scanning = new Scanner(System.in);
        System.out.println("Enter the ToDoLy.Task No you want  to Edit");
        taskNum = scanInput();
        taskNum = taskNum - 1;

        System.out.println("Enter the field you want to Edit");
        System.out.println("1.ToDoLy.Task Name  ");
    ...
    public void removeAnyTask() {
        {
            ...
            int removeChoice = 0;
            simpleTodoList.displayToDoList();
            System.out.println("Enter the ToDoLy.Task no. you want  to delete ");
            taskNum = scanInput();
            taskNum = taskNum - 1;
